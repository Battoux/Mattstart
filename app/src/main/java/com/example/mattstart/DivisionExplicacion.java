 ...
 * Use the {@link DivisionExplicacion#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DivisionExplicacion extends Fragment {
    private FragmentDivisionExplicacionBinding binding;
    public int limite=0;
     ...
     * @return A new instance of fragment DivisionExplicacion.
     */
    // TODO: Rename and change types and number of parameters
    public static DivisionExplicacion newInstance(String param1, String param2) {
        DivisionExplicacion fragment = new DivisionExplicacion();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDivisionExplicacionBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.sonido4.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void explicacion(){
        if(limite==0) {
            MainActivity.player = MediaPlayer.create(getContext(), R.raw.divexp);
