 ...
 * Use the {@link MultEjercicio1#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MultEjercicio1 extends Fragment {
    private FragmentMultEjercicio1Binding binding;
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    public View identificador;
    public int resultado=10,respuesta=0;

    // TODO: Rename and change types of parameters
    private String mParam1;
    private String mParam2;

    public MultEjercicio1() {
    ...
    public static MultEjercicio1 newInstance(String param1, String param2) {
        MultEjercicio1 fragment = new MultEjercicio1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMultEjercicio1Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnResultado2.setOnClickListener(new View.OnClickListener() {
            @Override
