...
import com.example.mattstart.databinding.FragmentMultiplicacionGraficosBinding;
import com.example.mattstart.databinding.FragmentMultiplicacionSimplesBinding;

import java.util.Random;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link MultiplicacionSimples#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MultiplicacionSimples extends Fragment {
    private FragmentMultiplicacionSimplesBinding binding;
     ...
     * @return A new instance of fragment MultiplicacionSimples.
     */
    // TODO: Rename and change types and number of parameters
    public static MultiplicacionSimples newInstance(String param1, String param2) {
        MultiplicacionSimples fragment = new MultiplicacionSimples();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMultiplicacionSimplesBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.textView10.setText(num1+"    x   "+num2+"=");
        binding.textView11.setText(num3+"   x   "+num4+"=");
        binding.textView12.setText(num5+"   x   "+num6+"=");
